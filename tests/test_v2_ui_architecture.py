...
UI_MODULES = [
    ...
    "components.tabs",
    "components.footer",
    "components.investor_partner",
    "components.investment_profile",
    "components.portfolio_builder",
    "components.recommendation_board",
    "pages",
    "pages.overview",
    "pages.technical",
    "pages.fundamentals",
...
def test_expected_v2_files_exist():
    for relative in (
        ...
        "components/investor_partner.py",
        "components/investment_profile.py",
        "components/portfolio_builder.py",
        "components/recommendation_board.py",
        "pages/overview.py",
        "pages/technical.py",
